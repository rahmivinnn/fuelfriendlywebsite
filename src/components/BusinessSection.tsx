...
const BusinessSection = () => {
  return (
    <section className="py-12 md:py-24 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 transition-colors duration-300">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="relative w-full max-w-[600px] rounded-lg overflow-hidden shadow-xl dark:shadow-gray-800">
              <motion.img
